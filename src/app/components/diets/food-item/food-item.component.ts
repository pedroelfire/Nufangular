...
export class FoodItemComponent{
  ...
  calculateCalories(event: any){
    this.caloriesPerGr = this.food_description.calories / this.food_description.metric_serving_amount
  ...
  chargeChart() {
    this.formIngredient=this.fb.group({
      ...
      metric_serving_amount: [this.food_description.metric_serving_amount, [Validators.required]],
      metric_serving_unit: [this.food_description.metric_serving_unit, [Validators.required]],
    })
      ...
      this.data = {
          ...
          datasets: [
              {
                  data: [this.food_description.protein, this.food_description.carbohydrate, this.food_description.fat],
                  backgroundColor: [documentStyle.getPropertyValue('--yellow-500'), documentStyle.getPropertyValue('--blue-500'), documentStyle.getPropertyValue('--purple-500')],
                  hoverBackgroundColor: [documentStyle.getPropertyValue('--yellow-500'), documentStyle.getPropertyValue('--blue-500'), documentStyle.getPropertyValue('--purple-500')]
              }
          ]
      };
